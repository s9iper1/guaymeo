...
public class RadioPlayerService extends Service implements PlayerCallback {
    ...
    List<com.pits.library.radio.RadioListener> mListenerList;
...
//            isClosedFromNotification = false;
    ...
    public void registerListener(com.pits.library.radio.RadioListener mListener) {
        mListenerList.add(mListener);
    }

    public void unregisterListener(com.pits.library.radio.RadioListener mListener) {
        mListenerList.remove(mListener);
    }

    private void notifyRadioStarted() {
        for (com.pits.library.radio.RadioListener mRadioListener : mListenerList) {
    ...
    private void notifyRadioTitle(String title) {
        for (com.pits.library.radio.RadioListener mRadioListener : mListenerList)
            mRadioListener.songInfo(title);
    }
    ...
    private void decodeStremLink(String streamLink) {
        new com.pits.library.radio.StreamLinkDecoder(streamLink) {
            @Override
